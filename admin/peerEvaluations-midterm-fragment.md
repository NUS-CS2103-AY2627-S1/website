...
{{ icon_info }} Some of these questions (e.g., contribution to DG) are omitted from the midterm peer evaluation but are included in the final peer evaluation (they are given here for your reference)
...
* **Meticulousness**:
  ...
  * Rarely misses compulsory course activities such as the pre-course survey.
* **Teamwork**: How willing are you to act as part of a team, contribute to team-level tasks, adhere to team decisions, etc. Honors all collectively agreed-upon commitments, such as weekly project meetings.
</box>
</div>
</div>
<p/>
...
* **Technical Competency**: Able to become competent in all the required tools and techniques.
