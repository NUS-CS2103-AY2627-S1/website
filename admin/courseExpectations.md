...
* Note that the **course contains more things than a typical student can do**, in order to provide enough things for even the strongest students to learn as much as they wish to.
...
* We have provided a _topic levels_ system (explained below) to guide you when prioritizing which things to do.
...
* The course uses a similar topic levels system to indicate the importance of other info in this website. i.e., information rated as level-1 is the most essential. ==Info rated level-4 are optional and can be ignored== without affecting your ability to follow the course.
...
This course deliberately avoids giving extra credit for exceeding the expected bars, in order to keep the workload manageable (of course, doing more will have its own rewards in terms of learning).
</div>
</div>
